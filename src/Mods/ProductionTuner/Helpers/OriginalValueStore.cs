...
{
    /// <summary>
    /// Tracks baseline (vanilla) values for game instances with zero-allocation integer hashing
    /// and lock-free lookups on the Unity main thread.
    /// </summary>
    public static class OriginalValueStore
    {
        ...
        private static int ComputeKey(int id, string key)
        {
